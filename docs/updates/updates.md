...
=== "Snapmaker U1 Printer"
    ...
    1. Once file is selected, __Upload & Upgrade__ becomes clickable, click Upload & Upgrade to start update process, then press Confirm to proceed with the update.
